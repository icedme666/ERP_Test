...
class HomeAccountTest(myunit.ErpTest):
    ''' 财务主页 '''
    ...
    def setUpClass(self):
        ...
        self.home = homepage.Homepage( self.driver, user_info.ACCOUNTANT )
        accountant = api_option.UserApi(user_info.ACCOUNTANT)
        self.my_stats = accountant.get_my_stats()
        self.new_orders = api_option.OrderApi().get_orders(token=accountant.get_token(), page=1, per_page=5, order='updated_at%20desc')['data']
        self.status = user_info.ACCOUNTANT_STATUS
